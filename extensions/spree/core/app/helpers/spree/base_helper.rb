module Spree
  module BaseHelper
    ...
    def variant_options_short(v, options={})
      v.options_text_short    
    end
    ...
    def display_sale_price(product_or_variant)
      product_or_variant.sale_price_in(current_currency).display_price.to_html
    end

    def display_origin_price(product_or_variant)
      product_or_variant.origin_price_in(current_currency).display_price.to_html
    end
