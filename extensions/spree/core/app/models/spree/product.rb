...
module Spree
  class Product < Spree::Base
    ...
    # ------- Add below --------- 
    # It shows the variants have option values and also can supply.

    def variants_and_option_values_can_supply(current_currency = nil)
      variants.includes(:option_values).active(current_currency).select do |variant|
        variant.option_values.any? && variant.can_supply?
      end
    end
