...
ActiveRecord::Schema.define(version: 20140918071357) do
  ...
  create_table "spree_claims", force: true do |t|
    t.string   "name"
    t.string   "email"
    t.string   "subject"
  ...
  create_table "spree_combination_layouts", force: true do |t|
    t.integer  "taxon_id"
    t.string   "text_1"
    t.string   "text_2"
    t.string   "text_3"
...
# Could not dump table "spree_variants" because of following NoMethodError
